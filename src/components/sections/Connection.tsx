        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <div className="space-y-10 text-lg md:text-xl text-muted-foreground font-light leading-relaxed">
              ...
              <p>
                O nosso foco não é apenas prolongar anos à vida, mas adicionar independência e dignidade a cada ano que passa. Uma medicina feita com escuta ativa, baseada em ciência e entregue com afeto.
              </p>
            </div>
          </FadeIn>
        </div>
