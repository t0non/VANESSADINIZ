        ...
        <PopoverContent side="top" align="end" sideOffset={16} className="w-[85vw] md:w-[320px] p-5 rounded-[24px] shadow-2xl border-none bg-[#FBFBF9]">
          ...
          <div className="grid grid-cols-1 gap-2">
            {[
              ...
              <Link key={idx} href={`https://wa.me/5511987654321?text=Olá,%20Dra.%20Vanessa.`} target="_blank" className="flex items-center gap-3 bg-white px-4 py-2.5 rounded-full border border-gray-100 hover:shadow-md transition group">
